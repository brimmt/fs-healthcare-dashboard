...
from app.services.encounter_service import get_encounter_by_id, get_all_encounters, get_encounters_by_patient_id, get_encounters_by_hospital_name, get_encounters_by_doctor_name
...
def test_get_encounter_by_id_returns_none_for_missing_encounter(mocker):
   ...
   mocker.patch('app.services.encounter_service.supabase.table', return_value=mock_table)
...
def test_get_all_encounters_returns_list(mocker):
   ...
   fake_response = mocker.Mock()
   fake_response.data = [
       {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "General Hospital", "doctor_name": "Dr. Smith"},
       {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "City Clinic", "doctor_name": "Dr. Jones"},
   ]
...
def test_get_encounters_by_patient_id_returns_list(mocker):
   ...
   fake_response = mocker.Mock()
   fake_response.data = [
       {"id": str(uuid4()), "patient_id": str(patient_id), "hospital_name": "General Hospital", "doctor_name": "Dr. Smith"},
       {"id": str(uuid4()), "patient_id": str(patient_id), "hospital_name": "City Clinic", "doctor_name": "Dr. Jones"},
   ]
...
def test_get_encounters_by_hospital_name_returns_list(mocker):
   ...
   fake_response.data = [
       {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "General Hospital", "doctor_name": "Dr. Smith"},
       {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "General Health Center", "doctor_name": "Dr. Jones"},
   ]
...
def test_get_encounters_by_doctor_name_returns_list(mocker):
    ...
    fake_response = mocker.Mock()
    fake_response.data = [
        {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "General Hospital", "doctor_name": doctor_name},
        {"id": str(uuid4()), "patient_id": str(uuid4()), "hospital_name": "City Clinic", "doctor_name": doctor_name},
    ]

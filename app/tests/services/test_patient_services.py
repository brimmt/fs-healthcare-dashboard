...
from app.services.patient_service import get_patient_by_id, get_all_patients, get_patient_by_name, get_patient_details
...
def test_get_all_patients_returns_list_of_patients(mocker):
   fake_patients = [
       {"id": uuid4(), "patient_name": "Alice Johnson", "age": 40, "gender":"Female","blood_type":"B+"},
       {"id": uuid4(), "patient_name": "Bob Smith", "age": 35, "gender":"Male","blood_type":"A-"},
   ]
...
def test_patient_by_name_returns_list_of_patients(mocker):
   fake_patients = [
       {"id": uuid4(), "patient_name": "Alice Johnson", "age": 30, "gender": "Female","blood_type":"B+"},
       {"id": uuid4(), "patient_name": "Alicia Keys", "age": 28, "gender":"Female","blood_type":"O-"},
   ]

...
from app.services.condition_service import get_all_conditions as service_get_all_conditions, get_condition_by_id as service_get_condition_by_id, get_conditions_by_encounter_id as service_get_conditions_by_encounter_id
...
async def get_conditions_by_encounter_id(encounter_id: UUID):
    ...
    if result is None or len(result) == 0:
        raise HTTPException(
            status_code=404, 
            detail="No conditions found for the specified encounter ID"
            )
    return result
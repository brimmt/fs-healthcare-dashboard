...
from app.services.test_result_service import (
    get_all_test_results as service_get_all_test_results,
    get_test_results_by_id as service_get_test_results_by_id,
    get_test_results_by_encounter_id as service_get_test_results_by_encounter_id,
)

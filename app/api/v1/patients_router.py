...
from app.services.patient_service import (
    get_all_patients as service_get_all_patients,
    get_patient_by_id as service_get_patient_by_id,
    get_patient_details as service_get_patient_details,
    get_patient_by_name as service_get_patients_by_name,
)
...
async def get_patients_by_name(patient_name: str):
    ...
    if result is None or len(result) == 0:
        raise HTTPException(
            status_code=404, detail="No patients found for the specified name"
        )
    return result
